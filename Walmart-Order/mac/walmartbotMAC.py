...
class Client(discord.Client):
    async def on_ready(self):
        ...
        #Asking user for date of webhook
        userInput = input("Enter date of webhook in format mm/dd/yyyy\n")
